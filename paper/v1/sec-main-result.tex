...
The consequence is that gradient descent on LSE objectives is exactly EM. It is not an approximation of EM. The discrete alternation of classical EM---compute responsibilities, then update parameters, then repeat---collapses into continuous, simultaneous optimization. Every gradient step is a responsibility-weighted update. Every trained network has been doing EM all along.
